classes = {
  ...
  "YEAST" => [
                     ...
                     {name: 'TIMES_CULTURED', required: false, type: 'int', comment: 'number of times reused'},
                     {name: 'MAX_REUSE', required: false, type: 'int'},
  ...
  "RECIPE" => [
                     ...
                     {name: 'FERMENTATION_STAGES', required: false, type: 'int'},
                     {name: 'PRIMARY_AGE', required: false, type: 'int', comment:'days'},
                     {name: 'PRIMARY_TEMP', required: false, type: 'double', comment:'C'},
                     {name: 'SECONDARY_AGE', required: false, type: 'int', comment:'days'},
                     {name: 'SECONDARY_TEMP', required: false, type: 'double', comment:'C'},
                     {name: 'TERTIARY_AGE', required: false, type: 'int', comment:'days'},
                     {name: 'TERTIARY_TEMP', required: false, type: 'double', comment:'C'},
                     {name: 'AGE', required: false, type: 'int', comment:'days'},
                     {name: 'AGE_TEMP', required: false, type: 'int', comment:'C'},
                     ...
                     {name: 'PRIMING_SUGAR_NAME', required: true, type: 'String'},
                     {name: 'CARBONATION_TEMP', required: true, type: 'double', comment:'C'},
